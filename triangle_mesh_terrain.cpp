...
void TriangleMeshTerrain::write_stl(std::ofstream& out,const ParametersSave&,const ParametersTerrain&,const std::string& mesh_name) const
{
  TriangleMesh::write_stl(out,mesh_name+".stl");
}
